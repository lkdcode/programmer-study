...
class MokuBoard private constructor(
    ...
    companion object {
        ...
        private val RIGHT_LINE = Point(0, +1)

        private val UP_LINE = Point(-1, 0)
        private val DOWN_LINE = Point(+1, 0)

        private val LEFT_UP_DIAGONAL = Point(-1, -1)
        private val RIGHT_DOWN_DIAGONAL = Point(+1, +1)

        private val RIGHT_UP_DIAGONAL = Point(+1, -1)
        private val LEFT_DOWN_DIAGONAL = Point(-1, +1)

package com.sb.adapter.archive.output.infrastructure.jooq.mapper.sort
...
private val DEFAULT_SORT = JMST_CALLIGRAPHY_ARCHIVE.CREATED_AT.desc()

private val AVAILABLE_PROPERTY = mapOf(
    "id" to JMST_CALLIGRAPHY_ARCHIVE.ID,
    "createdAt" to JMST_CALLIGRAPHY_ARCHIVE.CREATED_AT,
)

fun SortOptionList?.toCalligraphyArchiveSortField(): List<SortField<*>> =
    this
        ?.list
        .orEmpty()
        .mapNotNull {

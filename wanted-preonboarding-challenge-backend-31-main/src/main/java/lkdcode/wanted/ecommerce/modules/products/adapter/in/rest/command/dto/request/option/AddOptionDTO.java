...
public record AddOptionDTO(
    ...
    @Positive(message = "옵션 그룹 아이디는 양수만 가능합니다.")
    Long optionGroupId,
    ...
    public AddOptionModel getAddOptionModel() {
        return new AddOptionModel(
            getProductOptionGroupId(),
    ...
    private ProductOptionGroupId getProductOptionGroupId() {
        return new ProductOptionGroupId(this.optionGroupId);
    }

...
public class Category extends EntityValidator<Category> {
    ...
    @Size(max = 255, message = "imageURL은 최대 255자까지 허용됩니다.")
    ...
    @Builder
    public Category(Long id, String name, String slug, String description, Category parent, Integer level, String imageUrl, List<Category> children) {
        this.id = id;
        this.name = name;
        this.slug = slug;

...
@Component
class AppleKafkaConsumer {

    private val log = LoggerFactory.getLogger(this::class.java)

    @KafkaListener(
        topics = [KafkaAclTopic.APPLE],
        containerFactory = KafkaAclListenerFactory.APPLE,
    )
    fun consume(record: ConsumerRecord<String, String>, ack: Acknowledgment) {
        log.info("[APPLE_TOPIC] *** RECEIVED : partition={}, offset={}, key={}, value={}",

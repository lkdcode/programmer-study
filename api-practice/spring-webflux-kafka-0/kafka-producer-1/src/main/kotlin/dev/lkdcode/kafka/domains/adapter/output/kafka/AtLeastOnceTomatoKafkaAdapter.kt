...
import dev.lkdcode.kafka.framework.kafka.producer.AtLeastOnceKafkaProducer
import dev.lkdcode.kafka.framework.kafka.topic.KafkaTopic
import org.springframework.stereotype.Component
import reactor.core.publisher.Mono

@Component
class AtLeastOnceTomatoKafkaAdapter(
    private val atLeastOnceKafkaProducer: AtLeastOnceKafkaProducer,
) : AtLeastOnceTomatoProducerPort {

    override fun send(tomato: TomatoVo): Mono<TomatoDto> =
        atLeastOnceKafkaProducer

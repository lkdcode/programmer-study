...
import dev.lkdcode.kafka.framework.kafka.producer.AtMostOnceKafkaProducer
import dev.lkdcode.kafka.framework.kafka.topic.KafkaTopic
import org.springframework.stereotype.Component
import reactor.core.publisher.Mono

@Component
class AtMostOnceTomatoKafkaAdapter(
    private val atMostOnceKafkaProducer: AtMostOnceKafkaProducer,
) : AtMostOnceTomatoProducerPort {

    override fun send(tomato: TomatoVo): Mono<TomatoDto> =
        atMostOnceKafkaProducer
